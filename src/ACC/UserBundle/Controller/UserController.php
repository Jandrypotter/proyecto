...
class UserController extends Controller
{
    ...
    {
        return $this->render('ACCUserBundle:User:home.html.twig');
    }
    ...
    public function indexAction(Request $request)
    {
        ...
        else
        {
            ...
            $dql = "SELECT u FROM ACCUserBundle:User u ORDER BY u.id DESC";
        ...
        $deleteFormAjax = $this->createCustomForm(':USER_ID', 'DELETE', 'acc_user_delete');
        
        return $this->render('ACCUserBundle:User:index.html.twig', array('pagination' => $pagination, 'delete_form_ajax' => $deleteFormAjax->createView()));
    }
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ACCUserBundle:User:edit.html.twig', array('user' => $user, 'form' => $form->createView()));
    ...
    public function updateAction($id, Request $request)
    {
        ...
        if($form->isSubmitted() && $form->isValid())
        {
            ...
            $this->addFlash('mensaje', $successMessage);
            return $this->redirectToRoute('acc_user_edit', array('id' => $user->getId()));
        }
        return $this->render('ACCUserBundle:User:edit.html.twig', array('user' => $user, 'form' => $form->createView()));
    }
    ...
    public function viewAction($id)
    {
        ...
        $deleteForm = $this->createCustomForm($user->getId(), 'DELETE', 'acc_user_delete');
        
        return $this->render('ACCUserBundle:User:view.html.twig', array('user' => $user, 'delete_form' => $deleteForm->createView()));
    }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        $allUsers = $em->getRepository('ACCUserBundle:User')->findAll();
        $countUsers = count($allUsers);
        
        // $form = $this->createDeleteForm($user);
        $form = $this->createCustomForm($user->getId(), 'DELETE', 'acc_user_delete');
        $form->handleRequest($request);
